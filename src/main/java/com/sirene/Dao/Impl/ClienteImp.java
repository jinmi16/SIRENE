...
public class ClienteImp implements ClienteDao {
    ...
    @Override
    public ArrayList<EstadoCliente> listarEstadoCli() {
    ...
    @Override
    public void regresarAcorteSE(int id) {
    ...
    @Override
    public int getIdAntena(String nom) {
        int id = 0;
    ...
    @Override
    public void congelarCliente(int idCli, String fecha) {
    ...
    @Override
    public int getIdEstado(String nom) {
        int id = 0;
    ...
    @Override
    public void registrarCliente2(Cliente c, Connection cn) {
        try {
            String sql = "INSERT INTO cliente(apellido,nombre,DNI,direccion,correo,f_Inicio,tarifa,f_Vencimiento,f_corte,condicionAntena,mac,ip,frecuencia,anchoBanda,idEstado,idAntena,observacion,marca)"
                    + " VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            PreparedStatement ps = cn.prepareStatement(sql);
    ...
    @Override
    public ArrayList<Object[]> listarCliente() {
    ...
    @Override
    public ArrayList<Object[]> busClienteApell_Nom_Dni(String a, String n, String d, String marca) {
        ArrayList<Object[]> lst = new ArrayList<>();
        String sql;
        if (marca != "todas") {
    ...
    @Override
    public ArrayList<Cliente> BuscarX(int x, String cadena, boolean f) {
    ...
    @Override
    public ArrayList<Cliente> BuscarClientesActivos(int x, String cadena, int estado) {
        //x: 0=nombre, 1=apellido, 2=Dni
        ArrayList<Cliente> lst = new ArrayList<>();
    ...
    @Override
    public ArrayList<Object[]> BuscarCliCortSE(int x, String cadena) {
        //x: 0=nombre, 1=apellido, 2=Dni
        /*
    ...
    @Override
    public ArrayList<Object[]> BuscarCliCeRa(int x, String cadena) {
        //x: 0=nombre, 1=apellido, 2=Dni
    ...
    @Override
    public ArrayList<Object[]> BuscarCliRe(int x, String cadena) {
        //x: 0=nombre, 1=apellido, 2=Dni
    ...
    @Override
    public ArrayList<Object[]> listarCliCortSE() {
        //x: 0=nombre, 1=apellido, 2=Dni
    ...
    @Override
    public ArrayList<Object[]> listarCeRa() {
        //x: 0=nombre, 1=apellido, 2=Dni
    ...
    @Override
    public ArrayList<Object[]> listarClienteRetirado() {
        //x: 0=nombre, 1=apellido, 2=Dni
    ...
    @Override
    public ArrayList<Object[]> listarClienteEstado(int es) {
    ...
    @Override
    public ArrayList<Object[]> buscarCliente2(int es, String cadena, int x, String orden) {
    ...
    @Override
    public ArrayList<Object[]> buscarClienteEstado(int es, String cadena, int x) {
    ...
    @Override
    public Object[] llenarTodosLosCampos(int id) {
        // ArrayList<Object[]> list = new ArrayList<>();
    ...
    @Override
    public ArrayList<Object[]> buscarCliente(int x, String nomApe, String consulta) {
    ...
    @Override
    public boolean cortarServicio(int id) {
        boolean f = false;
    ...
    @Override
    public boolean habilitarCliente(int id, int e) {
        boolean f = false;
    ...
    @Override
    public Object[] buscarCliXid(int id) {
    ...
    @Override
    public Object[] buscarCliCongeladoXid(int id) {
    ...
    @Override
    public void DescongelarCliente(Cliente c) {
    ...
    @Override
    public void activarEstado(Cliente c, Connection cn) throws SQLException {
        String sql;
        if (c.getSaldo() > 0) {
    ...
    @Override
    public ArrayList<String> listarAntenaBaseCli() {
        ArrayList<String> lst = new ArrayList<>();
    ...
    @Override
    public ArrayList<String> listarAntenaBaseCliXtorre(String torre) {
        ArrayList<String> lst = new ArrayList<>();
        String sql;
        if (torre == "todas") {
