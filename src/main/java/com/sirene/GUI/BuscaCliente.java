...
public class BuscaCliente extends javax.swing.JDialog {
    ...
    public BuscaCliente(java.awt.Frame parent, boolean modal) {
        ...
        listarBusqueda(cboBusCampo.getSelectedIndex(), txtBuscar.getText().trim(), chkCliActivos.isSelected());
    ...
    private void listarBusqueda(int x, String cadena, boolean f) {
        int k = clienteDao.BuscarX(x, cadena, f).size();
        if (k > 0) {
            ...
            for (Cliente c : clienteDao.BuscarX(x, cadena, f)) {
    ...
    private void initComponents() {
        ...
        chkCliActivos = new javax.swing.JCheckBox();
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, -1, -1));
        ...
        chkCliActivos.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        chkCliActivos.setForeground(new java.awt.Color(255, 255, 255));
        chkCliActivos.setText("Incluir Clientes Activos");
        chkCliActivos.setOpaque(false);
        chkCliActivos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chkCliActivosActionPerformed(evt);
            }
        });
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 23, -1, 80));
    ...
    private void tblVistaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblVistaMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            id = (int) modTabla.getValueAt(i, 0);
            cliente = modTabla.getValueAt(i, 1).toString() + " " + modTabla.getValueAt(i, 2).toString();
            txtCliente.setText(cliente);
    ...
    private void cboBusCampoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboBusCampoActionPerformed
        ...
        boolean f = chkCliActivos.isSelected();
        if (x == 2) {
            txtBuscar.setText(null);
            listarBusqueda(x, txtBuscar.getText().trim(), f);
            txtBuscar.requestFocus();
        } else {
            listarBusqueda(x, txtBuscar.getText().trim(), f);
            txtBuscar.requestFocus();
...
//txtPrueva.setText("index = "+x);
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        int x = cboBusCampo.getSelectedIndex();
        boolean f = chkCliActivos.isSelected();
        int k = clienteDao.BuscarX(x, txtBuscar.getText().trim(), f).size();
        if (k > 0) {
            listarBusqueda(x, txtBuscar.getText().trim(), f);
    ...
    private void chkCliActivosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkCliActivosActionPerformed
        int x = cboBusCampo.getSelectedIndex();
        boolean f = chkCliActivos.isSelected();
...
// TODO add your handling code here:
    }//GEN-LAST:event_chkCliActivosActionPerformed
...
// TODO add your handling code here:
    ...
    private javax.swing.JCheckBox chkCliActivos;
