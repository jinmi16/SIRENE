...
public class BuscaClienteActivo extends javax.swing.JDialog {
    ...
    public BuscaClienteActivo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void listarBusqueda(int x, String cadena) {
        int k = clienteDao.BuscarClientesActivos(x, txtBuscar.getText().trim(), 1).size();
        if (k > 0) {
            ...
            for (Cliente c : clienteDao.BuscarClientesActivos(x, txtBuscar.getText().trim(), 1)) {
...
//txtPrueva.setText("index = "+x);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        CongelarServicioCliente.idcliente = id;
        //getTransferenciaDatos();
        CongelarServicioCliente.txtPago.setText(txtCliente.getText());
        CongelarServicioCliente.fecha();
        CongelarServicioCliente.llenarCampos();
        //CongelarServicioCliente.fecha();
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscaClienteActivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                BuscaClienteActivo dialog = new BuscaClienteActivo(new javax.swing.JFrame(), true);
