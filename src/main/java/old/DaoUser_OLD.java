 ...
 * @author JINMI
 */
public class DaoUser_OLD {

    public static Object[] logUser(String usuario, String passw) {
     ...
     String sql="DELETE FROM usuario WHERE idUsuario="+id+"";
      Connection cn = Conexion.abrir();
        try {
            ...
            Logger.getLogger(DaoUser_OLD.class.getName()).log(Level.SEVERE, null, ex);
        }
     
     }
     public static ArrayList<Usuario> listarUsuario_idPers(int idPer){
    ArrayList<Usuario> lst=new ArrayList<>();
   ...
   public static boolean registrar(Usuario p){
    boolean f=false;
   ...
   public static boolean getPasw(int idU,String pas){
   boolean pasw=false;
   ...
   public static void cambiarContraseña(Usuario p){
    ...
    public static boolean eliminar(int p){
    boolean f=false;
