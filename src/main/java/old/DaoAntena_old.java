...
public class DaoAntena_old {

    
    public static void registrar(Antena a) {
    ...
    public static ArrayList<Antena> listar() {
        ...
        try {
            ...
            Logger.getLogger(DaoAntena_old.class.getName()).log(Level.SEVERE, null, ex);
        }

        return lista;
    }

    public static ArrayList<Object[]> listar2() {
    ...
    public static ArrayList<Object[]> listarBuquedadNomTipo(String nom, String consulta) {
        ArrayList<Object[]> lista = new ArrayList<>();
        //{"Id", "Nombre", "IP", "Mac", "Frecuencia", "Canal", "Passw_Config", "Passw_conexion", "id_Ant_Enlace", "id_Serv", "id_Torre", "id_Tipo"};
        String sql = "SELECT a.idAntena,a.nombreAntena,a.ip,a.mac,a.frecuencia,a.canal,a.passwConfig,a.passwConeccion,a.idAntenaEnlace,s.nombreServidor,t.nombreTorre,ta.tipoAntena"
                + " FROM antena a INNER JOIN servidor s ON a.idServidor=s.idServidor INNER JOIN torre t ON a.idTorre=t.idTorre INNER JOIN tipoantena ta ON a.idTipo=ta.idtipo "
    ...
    public static ArrayList<String> antenaEE(String torre) {
    ...
    public static ArrayList<Antena> buscarNombre(String nom, String tipo) {
        ArrayList<Antena> lista = new ArrayList<>();
        String sql;
    ...
    public static ArrayList<Antena> listarAntEnlEmisora() {
        ArrayList<Antena> lista = new ArrayList<>();
    ...
    public static ArrayList<tipoAntena> listarTipoAntena() {
    ...
    public static void modificar(Antena a) {
    ...
    public static ArrayList<Object[]> listarBusAntena() {
    ...
    public static ArrayList<Object[]> BusAntXnom_torr_serv(String nom, String torr, String serv) {
    ...
    public static ArrayList<Object[]> BusAntXnom_torr_serv2(String nom, String consulta) {
    ...
    public static boolean existeAntena(String nom) {
        boolean f = false;
