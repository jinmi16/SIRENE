 ...
 * @author JINMI
 */
public class DaoTorre_OLD {

    public static void registrar(Torre t) {
        ...
        try {
            ...
            Logger.getLogger(DaoTorre_OLD.class.getName()).log(Level.SEVERE, null, ex);
        }


    }

    public static ArrayList<Torre> listar() {
    ...
    public static ArrayList<Torre> listarNobre() {
        ArrayList<Torre> lista = new ArrayList<>();
    ...
    public static void modificar(Torre t) {
    ...
    public static ArrayList<Torre> buscar(String nom) {
        ArrayList<Torre> lista = new ArrayList<>();
