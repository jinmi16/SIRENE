...
public class DaoPago_OLD {

    public static void RegistrarPago(Pago p, Connection cn) throws SQLException {
int k=p.getIdEstado();
String sql;
        if(k==4 || k==5){
    ...
    public static void RegistrarPagoAcuenta(Pago p, Connection cn) throws SQLException {
int k=p.getIdEstado();
String sql;
        if(k==4 || k==5){
             sql = "INSERT INTO pago(fecha,monto,periodo,idCliente,idPersonal)VALUES(?,?,?,?,?)";
    ...
    public static ArrayList<Object[]> ConsultarPago(String consulta,String consulta2) {
     ...
     public static boolean AnularPago(Pago p){
     boolean flag=true;
 ...
 public static ArrayList<Object[]> clientesXactivar() {
        ArrayList<Object[]> lst = new ArrayList<>();
 ...
 public static float pagoTotalFecha(String fecha){
 ...
 public static float pagoTotalFechaRango(String fechaI,String fechaF){
 ...
 return total;
  ...
  public static float pagoTotalFechaMes(int mes, int año){
